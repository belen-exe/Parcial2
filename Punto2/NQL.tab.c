...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_sentencias = 28,                /* sentencias  */
  YYSYMBOL_sentencia = 29,                 /* sentencia  */
  YYSYMBOL_create_op = 30,                 /* create_op  */
  YYSYMBOL_31_1 = 31,                      /* $@1  */
  YYSYMBOL_read_op = 32,                   /* read_op  */
  YYSYMBOL_update_op = 33,                 /* update_op  */
  YYSYMBOL_34_2 = 34,                      /* $@2  */
  YYSYMBOL_opt_where = 35,                 /* opt_where  */
  YYSYMBOL_delete_op = 36,                 /* delete_op  */
  YYSYMBOL_operador = 37,                  /* operador  */
  YYSYMBOL_pares = 38,                     /* pares  */
  YYSYMBOL_par = 39,                       /* par  */
...
{
       0,   204,   204,   206,   210,   211,   215,   216,   217,   218,
     222,   222,   226,   227,   239,   239,   243,   244,   253,   254,
     266,   267,   268,   269,   270,   271,   275,   276,   280,   289,
     290,   291,   292,   293
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NUMBER", "TRUE", "FALSE", "NEW", "GET", "SET", "DROP", "WHERE", "NUL",
  "EQ", "NE", "GT", "LT", "GE", "LE", "LBRACE", "RBRACE", "LPAREN",
  "RPAREN", "COMMA", "COLON", "$accept", "programa", "sentencias",
  "sentencia", "create_op", "$@1", "read_op", "update_op", "$@2",
  "opt_where", "delete_op", "operador", "pares", "par", "valor", YY_NULLPTR
};
...
{
       0,     4,    12,    22,    23,    27,     0,   -37,   -37,   -37,
     -37,   -37,     9,    18,    11,    20,   -37,   -37,   -37,    30,
     -37,    31,    32,     5,    32,     5,    13,    -8,   -37,   -37,
     -37,   -37,   -37,   -37,   -37,    -1,    -7,    -1,    -1,   -37,
      32,   -37,   -37,   -37,   -37,   -37,   -37,    24,   -37,   -37,
     -37,    34,   -37,     5,    -1,   -37
};
...
{
       2,     0,     0,     0,     0,     0,     3,     4,     6,     7,
       8,     9,     0,    12,     0,    18,     1,     5,    10,     0,
      14,     0,     0,     0,     0,     0,     0,     0,    26,    20,
      21,    22,    23,    24,    25,     0,     0,     0,     0,    11,
       0,    30,    29,    31,    32,    33,    13,    16,    19,    28,
      27,     0,    15,     0,     0,    17
};
...
{
      37,    48,    49,    41,    42,    43,    44,    12,     1,     2,
       3,     4,    45,    39,    47,    13,    40,    40,    55,    29,
      30,    31,    32,    33,    34,    14,    15,    16,    54,    18,
      19,    20,    21,    23,    25,    26,    51,    53,    38,    17,
      36,    50
};

static const yytype_int8 yycheck[] =
{
      25,    37,    38,     4,     5,     6,     7,     3,     8,     9,
      10,    11,    13,    21,    21,     3,    24,    24,    54,    14,
      15,    16,    17,    18,    19,     3,     3,     0,    53,    20,
      12,    20,    12,     3,     3,     3,    12,     3,    25,     6,
      24,    40
};
...
{
       0,     8,     9,    10,    11,    27,    28,    29,    30,    32,
      33,    36,     3,     3,     3,     3,     0,    29,    20,    12,
      20,    12,    31,     3,    34,     3,     3,    38,    39,    14,
      15,    16,    17,    18,    19,    37,    38,    37,    25,    21,
      24,     4,     5,     6,     7,    13,    40,    21,    40,    40,
      39,    12,    35,     3,    37,    40
};
...
yyreduce:
  ...
  case 10: /* $@1: %empty  */
#line 222 "NQL.y"
                          { strcpy(current_table, (yyvsp[-1].sval)); temp_field_count = 0; free((yyvsp[-1].sval)); }
#line 1311 "NQL.tab.c"
    break;

  case 11: /* create_op: NEW IDENTIFIER LBRACE $@1 pares RBRACE  */
#line 222 "NQL.y"
                                                                                                      { insert_record(); }
#line 1317 "NQL.tab.c"
    break;

  case 12: /* read_op: GET IDENTIFIER  */
#line 226 "NQL.y"
                   { strcpy(current_table, (yyvsp[0].sval)); has_where = 0; free((yyvsp[0].sval)); select_records(); }
#line 1323 "NQL.tab.c"
    break;

  case 13: /* read_op: GET IDENTIFIER WHERE IDENTIFIER operador valor  */
#line 227 "NQL.y"
                                                   {
        strcpy(current_table, (yyvsp[-4].sval));
        strcpy(where_field, (yyvsp[-2].sval));
        where_value = (yyvsp[0].val);
        has_where = 1;
        free((yyvsp[-4].sval));
        free((yyvsp[-2].sval));
        select_records();
...
#line 1343 "NQL.tab.c"
  ...
  case 15: /* update_op: SET IDENTIFIER LBRACE $@2 pares RBRACE opt_where  */
#line 239 "NQL.y"
                                                                                                                { update_records(); }
#line 1349 "NQL.tab.c"
    break;

  case 16: /* opt_where: %empty  */
#line 243 "NQL.y"
                 { has_where = 0; }
#line 1355 "NQL.tab.c"
    break;

  case 17: /* opt_where: WHERE IDENTIFIER operador valor  */
#line 244 "NQL.y"
                                    {
        strcpy(where_field, (yyvsp[-2].sval));
        where_value = (yyvsp[0].val);
...
#line 1366 "NQL.tab.c"
  ...
  case 18: /* delete_op: DROP IDENTIFIER  */
#line 253 "NQL.y"
                    { strcpy(current_table, (yyvsp[0].sval)); has_where = 0; free((yyvsp[0].sval)); delete_records(); }
#line 1372 "NQL.tab.c"
    break;

  case 19: /* delete_op: DROP IDENTIFIER WHERE IDENTIFIER operador valor  */
#line 254 "NQL.y"
                                                    {
        strcpy(current_table, (yyvsp[-4].sval));
        strcpy(where_field, (yyvsp[-2].sval));
...
#line 1422 "NQL.tab.c"
  ...
  case 28: /* par: IDENTIFIER COLON valor  */
#line 280 "NQL.y"
                           {
        strcpy(temp_record.fields[temp_field_count].name, (yyvsp[-2].sval));
        temp_record.fields[temp_field_count].value = (yyvsp[0].val);
        temp_field_count++;
        free((yyvsp[-2].sval));
    }
#line 1433 "NQL.tab.c"
  ...
  case 29: /* valor: NUMBER  */
#line 289 "NQL.y"
           { (yyval.val).type = TYPE_NUMBER; (yyval.val).data.num = (yyvsp[0].fval); }
#line 1439 "NQL.tab.c"
    break;

  case 30: /* valor: STRING  */
#line 290 "NQL.y"
           { (yyval.val).type = TYPE_STRING; strncpy((yyval.val).data.str, (yyvsp[0].sval), MAX_VALUE_LEN - 1); free((yyvsp[0].sval)); }
#line 1445 "NQL.tab.c"
    break;

  case 31: /* valor: TRUE  */
#line 291 "NQL.y"
         { (yyval.val).type = TYPE_BOOL; (yyval.val).data.boolean = 1; }
#line 1451 "NQL.tab.c"
    break;

  case 32: /* valor: FALSE  */
#line 292 "NQL.y"
          { (yyval.val).type = TYPE_BOOL; (yyval.val).data.boolean = 0; }
#line 1457 "NQL.tab.c"
    break;
